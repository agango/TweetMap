...
searchArray=['embiid', 'westbrook', 'durant', 'curry', 'draymond']
class StdOutListener(StreamListener):
    ...
    def on_data(self, doc_data):
        ...
        try:
            ...
            print data
            res=es.index(index="new_cloud", doc_type='tweet', body=data)
            print res['created']
        except:
            return 
...
if __name__ == "__main__":
    while True:
        try:
            ...
            stream.filter(track=searchArray, locations=[-180, -90, 180, 90])
